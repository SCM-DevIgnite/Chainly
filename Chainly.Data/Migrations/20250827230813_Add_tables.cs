        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LocationLongitude = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    LocationLatitude = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GoodProducts = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Reports", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Reports_ProductionLines_productionLineId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DefectiveType = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DefectiveProducts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DefectiveProducts_Reports_ReportId",
                        column: x => x.ReportId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DefectiveProducts_ReportId",
                table: "DefectiveProducts",
                column: "ReportId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reports_productionLineId",
                table: "Reports",
